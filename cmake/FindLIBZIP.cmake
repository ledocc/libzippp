...
if(LIBZIP_ROOT)
  set(_LIBZIP_SEARCH_ROOT ${LIBZIP_ROOT} NO_DEFAULT_PATH)
  list(APPEND _LIBZIP_SEARCHES _LIBZIP_SEARCH_ROOT)
endif()
message("ENV_LIBZIP_ROOT $ENV{LIBZIP_ROOT}")
set(ENV_LIBZIP_ROOT $ENV{LIBZIP_ROOT})
if(ENV_LIBZIP_ROOT)
  list(APPEND _LIBZIP_SEARCHES ENV_LIBZIP_ROOT NO_DEFAULT_PATH)
endif()
...
if(NOT LIBZIP_LIBRARY)
  foreach(search ${_LIBZIP_SEARCHES})
    find_library(LIBZIP_LIBRARY_RELEASE NAMES ${LIBZIP_NAMES} PATHS ${${search}} PATH_SUFFIXES lib)
    find_library(LIBZIP_LIBRARY_DEBUG NAMES ${LIBZIP_NAMES_DEBUG} PATHS ${${search}} PATH_SUFFIXES lib)
  endforeach()
